...
\includegraphics[width=0.25\textwidth]{./Figuras/LogoUCJC.png} &  & \begin{tabular}{l}\includegraphics[width=0.40\textwidth]{./Figuras/LogoUtad.pdf} \\[3.4cm] \phantom{x}  \end{tabular}\\ 
\end{tabular}
\end{center}
...
\begin{longtable}{l p{13.7cm}}
	{\Large \textbf{Convocatoria: }} & {\Large \fechaEntrega}\\[0.3cm]
