...
Para comenzar a conceptualizar un diseño de videojuego, primero recopilamos en una tabla una serie de referencias del género de los juegos de ritmo. Esta tabla nos proporcionó una visión del estado actual del mercado de videojuegos en este género e inspiró algunas ideas para nuestro propio desarrollo. La tabla es la siguiente:
...
\begin{table}[htbp]
	...
	\begin{tabular}{|l|l|c|}
		...
		\hline
		\textit{Arcaea} & Similar a Piano Tiles. Incrementa la profundidad añadiendo distintas alturas. & \multicolumn{1}{l|}{\textcolor[rgb]{ .02,  .388,  .757}{https://www.youtube.com/watch?v=ZcF9JQ44\_sw}} \\
		\hline
		\textit{Beat \& Shapes} & Se basa en esquivar obstáculos, aunque no necesariamente al ritmo de la música. Feedback visual al ritmo de la música. & \multicolumn{1}{l|}{\textcolor[rgb]{ .02,  .388,  .757}{https://www.youtube.com/watch?v=2VpqK2E8NRY}} \\
		\hline
		\textit{Beat Saber} & Formato VR. Se deben romper bloques al ritmo de la música. & \multicolumn{1}{l|}{\textcolor[rgb]{ .02,  .388,  .757}{https://www.youtube.com/watch?v=pa4vrynwkwY}} \\
		\hline
		\textit{Bullets Per Minute} & First Person Shooter en el que las acciones se deben realizar al ritmo de la música. & \multicolumn{1}{l|}{\textcolor[rgb]{ .02,  .388,  .757}{https://www.youtube.com/watch?v=cq-E6s91KyM}} \\
		\hline
		\textit{Crypt of the NecroDancer} & Acciones limitadas por casillas y al ritmo de la música. & \multicolumn{1}{l|}{\textcolor[rgb]{ .02,  .388,  .757}{https://www.youtube.com/watch?v=u\_avgU1u6yM}} \\
		\hline
		\textit{Cytus} & Estilo Osu!. & \multicolumn{1}{l|}{\textcolor[rgb]{ .02,  .388,  .757}{https://www.youtube.com/watch?v=k\_dibEIH4DE}} \\
		\hline
		\textit{Disaster Band} & Estilo Trombone Champ pero cooperativo. & \multicolumn{1}{l|}{\textcolor[rgb]{ .02,  .388,  .757}{https://www.youtube.com/watch?v=prU6dtBEpCI}} \\
		\hline
		\textit{Elite Beat Agents} & Estilo Osu!. & \multicolumn{1}{l|}{\textcolor[rgb]{ .02,  .388,  .757}{https://www.youtube.com/watch?v=FDfKdrdRbkA}} \\
		\hline
		\textit{Friday Night Funkin} & Estilo Piano Tiles. Caen flechas al ritmo de las canciones, teniendo apoyo visual con el movimiento de los personajes. & \multicolumn{1}{l|}{\textcolor[rgb]{ .02,  .388,  .757}{https://www.youtube.com/watch?v=xErhpjV8qNI}} \\
		\hline
		\textit{Fuser} & Simulador de DJ. & \multicolumn{1}{l|}{\textcolor[rgb]{ .02,  .388,  .757}{https://www.youtube.com/watch?v=Ego\_IsxQw1I}} \\
		\hline
		\textit{Geometry Dash} & Plataformas 2D con scroll lateral. Esquivar obstáculos (al ritmo de la música?). & \multicolumn{1}{l|}{\textcolor[rgb]{ .02,  .388,  .757}{https://www.youtube.com/watch?v=k90y6PIzIaE}} \\
		\hline
		\textit{Guitar Hero} & Simulador de guitarra. & \multicolumn{1}{l|}{\textcolor[rgb]{ .02,  .388,  .757}{https://www.youtube.com/watch?v=YJgagY6j6ro}} \\
		\hline
		\textit{Hi-Fi Rush} & Aventura 3º persona. Acciones al ritmo de la música. & \multicolumn{1}{l|}{\textcolor[rgb]{ .02,  .388,  .757}{https://www.youtube.com/watch?v=\_GErIWYIhVc}} \\
		\hline
		\textit{Impossible Game} & Plataformas 2D con scroll lateral. Esquivar obstáculos (al ritmo de la música?). & \multicolumn{1}{l|}{\textcolor[rgb]{ .02,  .388,  .757}{https://www.youtube.com/watch?v=iQPEbHQZm68}} \\
		\hline
		\textit{Lost in Harmony} & Esquivar obstáculos (no necesariamente al ritmo). Feedback visual acorde al ritmo. & \multicolumn{1}{l|}{\textcolor[rgb]{ .02,  .388,  .757}{https://www.youtube.com/watch?v=ZpumeaGwJvQ}} \\
		\hline
		\textit{Metal: Hellsinger} & FPS. Acciones al ritmo de la música. & \multicolumn{1}{l|}{\textcolor[rgb]{ .02,  .388,  .757}{https://www.youtube.com/watch?v=vzrFrhetMhA}} \\
		\hline
		\textit{Minna Rhythm} & Diferentes minijuegos rítmicos. & \multicolumn{1}{l|}{\textcolor[rgb]{ .02,  .388,  .757}{https://www.youtube.com/watch?v=2feG25a3VfQ}} \\
		\hline
		\textit{Osu!} & Circulos se van cerrado y se deben de dar en el punto correcto de la canción. & \multicolumn{1}{l|}{\textcolor[rgb]{ .02,  .388,  .757}{https://www.youtube.com/watch?v=oI6X1pDMNlg}} \\
		\hline
		\textit{PaRappa The Rapper} & Juego de rap músical. & \multicolumn{1}{l|}{\textcolor[rgb]{ .02,  .388,  .757}{https://www.youtube.com/watch?v=y3SI4Grases}} \\
		\hline
		\textit{Patapon} & 2D scroll lateral. Diferentes ritmos para diferentes acciones. & \multicolumn{1}{l|}{\textcolor[rgb]{ .02,  .388,  .757}{https://www.youtube.com/watch?v=Gvd21YW966A}} \\
		\hline
		\textit{Piano Tiles} & Piano Tiles. & \multicolumn{1}{l|}{\textcolor[rgb]{ .02,  .388,  .757}{https://www.youtube.com/watch?v=kVIWzN0DmTc}} \\
		\hline
		\textit{Pistol Whip} & FPS VR. Acciones al ritmo de la música. & \multicolumn{1}{l|}{\textcolor[rgb]{ .02,  .388,  .757}{https://www.youtube.com/watch?v=mA75FYv6Nzg}} \\
		\hline
		\textit{Sayonara Wild Hearts} & Movimiento 3D/2D en niveles musicales. & \multicolumn{1}{l|}{\textcolor[rgb]{ .02,  .388,  .757}{https://www.youtube.com/watch?v=F-RyxYcxSQ4}} \\
		\hline
		\textit{SingStar} & Simulador de canto. & \multicolumn{1}{l|}{\textcolor[rgb]{ .02,  .388,  .757}{https://www.youtube.com/watch?v=dNIOuio4-uU}} \\
		\hline
		\textit{Soundfall} & Hack\&Slash. Acciones al ritmo de la música. & \textcolor[rgb]{ .02,  .388,  .757}{https://www.youtube.com/watch?v=UhqempUAW2A} \\
		\hline
		\textit{Taiko no Tatsujin: Drum Session} & Juego de tambor rítmico. & \textcolor[rgb]{ .02,  .388,  .757}{https://www.youtube.com/watch?v=f7Yimxud4UI} \\
		\hline
		\textit{Theatrhythm Final Bar Line} & Universo Final Fantasy. Diferentes minijuegos musicales. & \textcolor[rgb]{ .02,  .388,  .757}{https://www.youtube.com/watch?v=3EktIGradBI} \\
		\hline
		\textit{TLOZ: Cadence of Hyrule} & Acciones limitadas por casillas y al ritmo de la música. & \textcolor[rgb]{ .02,  .388,  .757}{https://www.youtube.com/watch?v=T2vSGCXkYac} \\
		\hline
		\textit{Trombone Champ} & Seguir melodía música, con indicaciones lineales (al estilo de un trombón). & \textcolor[rgb]{ .02,  .388,  .757}{https://www.youtube.com/watch?v=l-w5phrKu7Q} \\
		\hline
		\textit{Voez} & Piano tiles avanzado donde se truecan las lineas de notas & \textcolor[rgb]{ .02,  .388,  .757}{https://www.youtube.com/watch?v=cInSMLRcvKo} \\
		\hline
	\end{tabular}%
}
\caption{Referencia}
