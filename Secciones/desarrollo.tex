...
\begin{figure}[h!]
	\centering
	\subfigure{\includegraphics[width=0.26\textwidth]{./Figuras/Desarrollo/LemmingsLogo.png}\label{fig:LemmingsLogo}}
	\hfil
	\subfigure{\includegraphics[width=0.45\textwidth]{./Figuras/Desarrollo/LemmingsGame.png}\label{fig:LemmingsGame}}
